dataset_info = dict(
    dataset_name="pose24",
    paper_info=dict(
        author="SAM-3D-Body / Theia",
        title="MHR70 body-only 24-keypoint subset",
    ),
    keypoint_info={
        ...
        23: dict(name="neck", id=23, color=[51, 153, 255], type="upper", swap=""),
    },
    skeleton_info={
        ...
        18: dict(link=("neck", "left_shoulder"), id=18, color=[51, 153, 255]),
        19: dict(link=("neck", "right_shoulder"), id=19, color=[51, 153, 255]),
        20: dict(link=("left_elbow", "left_olecranon"), id=20, color=[0, 255, 0]),
        21: dict(link=("right_elbow", "right_olecranon"), id=21, color=[255, 128, 0]),
        22: dict(link=("left_shoulder", "left_acromion"), id=22, color=[0, 255, 0]),
        23: dict(link=("right_shoulder", "right_acromion"), id=23, color=[255, 128, 0]),
    },
    joint_weights=[
        1.0,
        1.2,
